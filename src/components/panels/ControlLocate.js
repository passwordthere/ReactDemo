        ...
        <div className='ControlLocate'>
            <div className='LeftControlLocate'>
                <div style={{height: '80%', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '20px', fontSize: '1.6rem', fontWeight: '600'}}>
                    <div>颌拖（mm）</div>
                    <div><Form.Control style={InputStyle} className='outline-primary' type="textarea"/></div>
            ...
            <div className='RightControlLocate'>
                <div style={{height: '80%', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '20px', fontSize: '1.6rem', fontWeight: '600'}}>
                    ...
                    <div><Form.Control style={InputStyle} className='outline-primary' type="textarea"/></div>
                    <div style={{display: 'flex', gap: '10px'}}>
                        <Button style={{borderRadius: '1.2rem', width: '37%'}}><CaretLeftOutlined/>上移</Button>
                        <Button style={{borderRadius: '1.2rem', width: '37%'}}><CaretRightOutlined/>下移</Button>
                    </div>
                </div>
